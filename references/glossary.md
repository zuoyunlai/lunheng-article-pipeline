...
**触发条件**：T4 分析员在 T1 + T2 + T4 全部完成后才 spawn

---

### 修订回环 ≤2 轮降级（v2.2.0）
**规则**：
- 第 1 轮修订：正常流程（T8 审计 → T8 修订 → T8 复审）
...
**不采信报告**：T8 写手两次"报告完成但未写盘"事故触发此铁律
