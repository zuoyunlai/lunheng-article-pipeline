...
#     T9 同行评审（6 维度评分）+ G14 中文 AI 痕迹闸（8 类检测）+ 方法论足迹面板
# 4. 交付一份带引用来源的高质量长文
```
...
9. **Phase 4.5 可选派发**（**默认关闭**，Phase 0 明确勾选才走）：
   ...
   - **G14 中文 AI 痕迹闸**（可选）：与 T6 并行，8 类检测（学术模板语/句式同质化/学术套话/破折号/三项排比/人称/辨识度/党报话语），0-2 类 Pass / 3-4 类 Warning / 5+ 类 Fail
...
| **T9 同行评审**（可选） | 预演期刊审稿（6 维度评分 → accept/minor/major/reject） | Phase 4.5（默认关闭，主人拍板） |
