...
```bash
openclaw skills install @zuoyunlai/lunheng-article-pipeline@2.12.72  # 建议 pin 具体版本
```
...
- 重量档（8000+ 字）：约 2-4 小时（估计值；已有 1 例实测 ~2h40m，仍不足 3 档位实测；登记表 = `references/_shared/真源/performance-benchmarks.md`）
