...
**v2.12.6**（2026-09-10，当前版本）— ClawHub 安全审计 11 项语义 finding 全量修订 + 净化链代码保真修复（教训 #300）+ changelog 单一真源。[MIT License](LICENSE)。
...
| **v2.12.6** | **2026-09-10** | **当前** | **ClawHub 安全审计 11 项语义 finding 全量修订 + 净化链代码保真修复（教训 #300）+ changelog 单一真源** |
