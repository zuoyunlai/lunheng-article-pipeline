...
**v2.12.6**（2026-09-10，当前版本）— ClawHub 安全审计 11 项语义 finding 全量修订 + 净化链代码保真修复（教训 #300）+ changelog 单一真源 + 版本一致性检查回归修复。[MIT License](LICENSE)。
...
| **v2.12.6** | **2026-09-10** | **当前** | **ClawHub 安全审计 11 项语义 finding 全量修订 + 净化链代码保真修复（教训 #300）+ changelog 单一真源 + 角色编号检查迁入单一真源** |
