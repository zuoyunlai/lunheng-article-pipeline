...
**v2.8.1**（2026-09-08，当前版本）— **P0-3 并发防护 + P1-1 性能基准 + P1-3/P1-4 设计文档**。新增项目锁机制防止并发冲突，补充性能基准测试数据，提供 SKILL.md 精简优化和增量 M 门验证设计方案。[MIT License](LICENSE)。
